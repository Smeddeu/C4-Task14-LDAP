...
$servers->setValue('server','host','192.168.12.100');
...
$servers->setValue('server','base',array('dc=z2,dc=tom,dc=hier'));
...
$servers->setValue('login','bind_id','cn=admin,dc=z2,dc=tom,dc=hier');
